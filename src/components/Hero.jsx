    ...
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        ...
        <div>
          ...
          Passionate web developer skilled in creating <br className="sm:block hidden" />dynamic and user-friendly websites with a focus on modern technologies.
          </p>
        </div>
      </div>
      <ComputersCanvas />
      ...
      items-center">
        <a href='#about'>
          <div style={{borderRadius: '50% 50%'}} className="w-[35px] h-[64px] 
